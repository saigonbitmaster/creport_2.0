...
let PayoutController = class PayoutController {
    ...
    async create(createPayoutDto) {
        return await this.service.create(createPayoutDto);
    }
    async update(id, updatePayoutDto) {
        return await this.service.update(id, updatePayoutDto);
    }
    async delete(id) {
...
], PayoutController.prototype, "index", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], PayoutController.prototype, "find", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_dto_1.CreatePayoutDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_dto_1.UpdatePayoutDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PayoutController.prototype, "delete", null);
PayoutController = __decorate([
    (0, common_1.Controller)('payouts'),
    __metadata("design:paramtypes", [service_1.PayoutService])
], PayoutController);
