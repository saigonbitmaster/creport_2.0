...
let ReviewController = class ReviewController {
    ...
    async create(createReviewDto) {
        return await this.service.create(createReviewDto);
    }
    async update(id, updateReviewDto) {
        return await this.service.update(id, updateReviewDto);
    }
    async delete(id) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_dto_1.CreateReviewDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_dto_1.UpdateReviewDto]),
    __metadata("design:returntype", Promise)
...
ReviewController = __decorate([
    ...
    __metadata("design:paramtypes", [service_1.ReviewService])
], ReviewController);
