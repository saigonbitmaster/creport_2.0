...
const authProvider = (
  ...
  checkAuth: async () => {
    ...
    if (isSkipCheckAccessToken) return Promise.resolve();
    ...
    try {
      ...
      console.log("CHECKAUTH START, tokenDecoded:::", tokenDecoded);
      ...
      console.log("GET NEW REFRESH TOKEN SUCCESS AT AUTH PROVIDER");
      return Promise.resolve();
    } catch (error) {
